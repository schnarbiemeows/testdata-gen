...
object WholeNumberTypeGenerator extends Generator {
  ...
  /**
    ...
    * @return - string
    */
  def makeRandomWholeNumber(format: String, qualifiers:Array[String]):String = {
    var length:Int = 10
    var min:Long = 0
    var max:Long = 0
  ...
  def makeRangedWholeNumber(typeName:String, format: String, qualifiers:Array[String],arrayNum:Int, fileNum: Int):String = {
    var length:Int = 10
    var linbase:Long = 0
    var linadd:Long = 0
    var nullPercentage:Double = 0.0
